...
the code here is adapted from Sylwester & Purver (2015)
"""
...
#input file
inputFile = "largest_cc_RIGHT_nodelist.csv"

#output files
sample1 = "sample1_RIGHT.csv"

remainingList = "remaining_RIGHT.csv"

originalList = splitText('largest_cc_RIGHT_nodelist.csv')
len(originalList)

sample1 = drawRandom(originalList, 100000, 'sample1_RIGHT.csv')
#now to import it 
sample1 = pd.read_csv('sample1_RIGHT.csv', header=None)
