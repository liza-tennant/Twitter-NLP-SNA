...
#try to return tweets for deleted user
#trial = collect_tweets_from_user(316669966)
#type(trial) == type(None) #returns true if user does not exist/tweets cannot be retrieved
...
#broke at user 966401042626826241 - not collected from this user 
#last collected from: 966396905772040193
################################################################
############ COLLECTING THE REST ##############################
################################################################
